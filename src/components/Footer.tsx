        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 mb-4">
              The official ECE Student Society fostering innovation, learning, and community among aspiring engineers.
            </p>
            <div className="flex space-x-4">
              <motion.a
                whileHover={{ scale: 1.1, y: -2 }}
                href="#"
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-cyan-500 hover:to-purple-600 rounded-lg flex items-center justify-center transition-all shadow-lg hover:shadow-cyan-500/50"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li>ECE Department</li>
              <li className="hover:text-cyan-400 transition-colors">contact@communique.edu</li>
